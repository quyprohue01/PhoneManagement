					...
					<div class="row g-0">
						...
						<div class="col-md-6 col-lg-7 d-flex align-items-center">
							<div class="card-body p-4 p-lg-5 text-black">
								...
								<form action="Controller_DangNhapAdmin" method="post">
									<div class="d-flex align-items-center mb-3 pb-1">
										<a href="HomePageController"><img alt=""
											src="ImagePhone/Shopee.png"> </a>
									</div>

									<h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Đăng nhập tài khoản admin</h5>

									<div class="form-outline mb-4">
										<input name="TenDN" type="text" id="form2Example17"
											class="form-control form-control-lg"
											placeholder="Nhập tên đăng nhập" /> <label class="form-label"
											for="form2Example17">Tên đăng nhập</label>
									</div>
